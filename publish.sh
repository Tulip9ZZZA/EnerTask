...
echo "🥕 Publishing EnerTask → github.com/Tulip9ZZZA/EnerTask"
echo ""
...
if git remote get-url origin >/dev/null 2>&1; then
  git remote set-url origin "https://github.com/Tulip9ZZZA/EnerTask.git"
else
  git remote add origin "https://github.com/Tulip9ZZZA/EnerTask.git"
fi
...
echo "   1. github.com/Tulip9ZZZA/EnerTask → Settings → General → make it PUBLIC"
